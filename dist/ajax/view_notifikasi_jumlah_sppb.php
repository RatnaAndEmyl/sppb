...
$kode_sppb =  isset($tampil['kode_sppb']) ? $tampil['kode_sppb'] : '';
...
$jumlah_pemenuhan =  isset($tampil_jumlah_pemenuhan['jumlah']) ? $tampil_jumlah_pemenuhan['jumlah'] : ''; 
...
$sql_cari_harga = $koneksi_master->query("SELECT harga_satuan FROM pb_transaksi.tb_po_detail WHERE kode_po='$kode_po' AND kode_sppb='$kode_sppb' AND kode_barang='$kode_barang' AND status='A'");
$tampil_cari_harga = $sql_cari_harga->fetch_assoc();

// $harga_satuan = $tampil_cari_harga['harga_satuan'];
$harga_satuan = isset($tampil_cari_harga['harga_satuan']) ? $tampil_cari_harga['harga_satuan'] : '';
...
<div class="form-group">
    ...
    <input type="number" class="form-control" onkeyup="hitung();" id="jumlah_barang_po" name="jumlah_pemenuhan" step="0.1" placeholder="Masukkan Jumlah PO Barang" required>
</div>

<div class="form-group">
    <label for="exampleInputEmail111">Harga Satuan (Rp) </label>
    <input type="currency" class="form-control" name="harga_satuan" onkeyup="hitung();" id="harga_satuan" placeholder="Masukan Harga Satuan" value='<?php echo $harga_satuan; ?>' <?php echo $status_input; ?>>
</div>
<div class="form-group">
    <label for="exampleInputEmail111">Total Harga (Rp)</label>
    <input type="currency" class="form-control" onkeypress="hitung();" id="total" placeholder="Total Harga PO Barang" readonly>
</div>

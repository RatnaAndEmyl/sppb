...
$jumlah_total = $jumlah_permintaan - $jumlah_pemenuhan; //jumlah_total itu untuk menghitung jumlah permintaan yang dari permintaan detail trs dikurang jumlah pemenuhan yang diinputkan di bbk detail

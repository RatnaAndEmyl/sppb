$("#kode_gudang").change(function(){
    ...
    $.ajax({
        type: "POST",
        dataType: "html",
        url: "dist/ajax/cari_nama.php", //yang url tu mengarahkan ke folder ajax dan ke file cari_nama.php, oleh karena itu imbah kita olah di js, kita bikin file lagi di folder ajax dengan nama yang sama supaya lebih mudah...
        ...
        success: function(msg){
            ...
            // jika dapat mengambil data,, tampilkan di combo box kota
                ...
                $("#cari_nama").html (msg);      //ini nanti akan mengirimkan ke nama pemohon, makanya nama pemohon itu tadi diberi id kaya gini -> id="cari_nama"                                             
            }

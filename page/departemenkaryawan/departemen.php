        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <a href="?page=departemen&aksi=tambah" class="btn btn-primary" style="margin-bottom: 5px; "><i class="fas fa-plus-circle"></i> Tambah Data Departemen</a>
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    $sql = $koneksi_master->query("SELECT * FROM pb_master.tb_departemen  where status='A' ORDER BY kode_departemen asc");

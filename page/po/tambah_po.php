                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control" name="tgl_create" id="cari_permintaan_barang_sppb">
                                                ...
                                                $sql1 = $koneksi_master->query("SELECT a.tgl_create, a.nama_barang, a.jumlah_permintaan, a.kode_sppb, a.nama_satuan FROM pb_transaksi.tb_sppb_detail a INNER JOIN pb_transaksi.tb_sppb b ON a.kode_sppb=b.kode_sppb WHERE a.STATUS='A' AND b.STATUS='A' AND b.kode_gudang='$kode_gudang_po' AND a.status_sppb='Y' 
                                                
                                                AND NOT EXISTS (SELECT x.kode_barang, x.kode_sppb FROM pb_transaksi.tb_po_detail x 
                                                
                                                WHERE (x.status_po='Y' OR x.jumlah_permintaan=x.jumlah_pemenuhan) AND x.status='A' AND x.kode_barang=a.kode_barang AND x.kode_sppb=a.kode_sppb)
                                                ");

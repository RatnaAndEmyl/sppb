                                    ...
                                    <table id="example1" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" style="text-align:center; vertical-align:middle;">Tanggal BBK</th>
                                                ...
                                                if ($level == 'ADMIN') {
                                                    if ($tampil_count_status['jumlah'] <> 0) { ?>
                                                        <tr>
                                                            ...
                                                            <td style="text-align:center; vertical-align:middle;">
                                                                <a href="?page=bbk&aksi=detail&kode_bbk=<?php echo $data['kode_bbk']; ?>&pc=<?php echo $angka; ?>&oc=<?php echo md5($data['kode_bbk'] . $angka); ?>" class="btn btn-success"><i class="fas fa-eye"></i></a>
                                                                ...
                                                                <?php if (($tampil_count_status['jumlah'] <> 0) AND ($_SESSION['s_kode_user'] == $data['create_by']) AND ($data['status_bbk'] <> 'XX')) { ?>
                                                                    <a href="?page=bbk&aksi=hangus_bbk&kode_bbk=<?php echo $data['kode_bbk']; ?>&pc=<?php echo $angka; ?>&oc=<?php echo md5($data['kode_bbk'] . $angka); ?>" class="btn btn-dark" title="Hapus Data"><i class="fa fa-sign-language"></i></a>

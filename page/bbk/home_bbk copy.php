            ...
            <div class="col-12">
                        ...
                        <div class="card">
                            <div class="table-responsive" style="padding-left:20px;padding-right:20px;padding-bottom:20px;padding-top:20px;">
                                <div class="row">
                                    ...
                                    <div class="col-md-4" style=" padding-bottom: 10px;">
                                        <div class="input-group-prepend">
                                            <label class="input-group-text" for="inputGroupSelect01" style="font-weight: bold; width: 90px; text-align:right;">Gudang</label>
                                            <select class="custom-select" id="pilih_gudang" name="pilih_gudang" style="width: 200px;" required>
                                                ...
                                                $sql1 = $koneksi_master->query("SELECT * FROM pb_master.tb_gudang ORDER BY kode_gudang ASC");
                                    ...
                                    <div class="col-md-4" style="padding-top: 10px; padding-bottom: 10px;">
                                        <div class="input-group-prepend">
                                            <label class="input-group-text" for="inputGroupSelect01" style="font-weight: bold; width: 90px; text-align:right;">Status</label>
                                    ...
                                    <?php if ($level == 'ADMIN') { ?>
                                        <div class="col-md-4" style="padding-top: 10px; padding-bottom: 10px;">
                                            <div class="input-group-prepend">
                                                <label class="input-group-text" for="inputGroupSelect01" style="font-weight: bold; width: 90px; text-align:right;">Departemen</label>
                                                <select class="custom-select" id="pilih_departemen" name="pilih_departemen" style="width: 200px;" required>

                                                    <?php

                                                    $sql1 = $koneksi_master->query("SELECT * FROM pb_master.tb_departemen_karyawan ORDER BY kode_departemen ASC");
                                    ...
                                    <?php if ($level <> 'USER') { ?>
                                        <div class="col-md-4" style="padding-top: 10px; padding-bottom: 10px;">
                                            <div class="input-group-prepend">
                                                <label class="input-group-text" for="inputGroupSelect01" style="font-weight: bold; width: 90px; text-align:right;">Pengguna</label>
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">DAFTAR BARANG KELUAR <?php echo $_SESSION['s_pilih_tanggal'] . $_SESSION['s_status_bbk']; ?> (<?php echo $_SESSION['s_pilih_pengguna'] ?>) (<?php echo $_SESSION['s_pilih_departemen'] ?>)</h3>
                    </div>
                    <div class="card-body">
                    <?php if ($level <> 'SUPERVISOR') { ?>
                        ...
                        <div class="row">
                            <?php
                            // $sqltext = "SELECT * FROM pb_transaksi.tb_bbk where status='A'";

                            $sqltext = "SELECT a.kode_bbk, a.tanggal_bbk, c.nama, a.jabatan, b.nama_gudang, a.status_bbk, c.nik FROM pb_transaksi.tb_bbk a INNER JOIN pb_master.tb_gudang b ON a.kode_gudang=b.kode_gudang INNER JOIN pb_role.tb_user c ON a.kode_user=c.kode_user INNER JOIN pb_master.tb_departemen_karyawan d ON c.kode_departemen=d.kode_departemen ";
                            ...
                            AND a.status_bbk ='$_SESSION[s_status_bbk]'
                            AND b.nama_gudang ='$_SESSION[s_pilih_gudang]'
                            AND d.nama_departemen = '$_SESSION[s_pilih_departemen]'";

                            $sqltext = $sqltext . " WHERE status='A' ORDER BY tgl_create DESC ";

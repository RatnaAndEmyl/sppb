            ...
            <div class="col-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4" style=" padding-bottom: 10px;">
                                        <div class="input-group-prepend">
                                            ...
                                            <select class="custom-select" id="pilih_gudang_bbk" name="pilih_gudang_bbk" style="width: 200px;" required>
                                                ...
                                                while ($datacek = $sql1->fetch_assoc()) {
                                                    ...
                                                    if ($_SESSION['s_pilih_gudang_bbk'] == $datacek['nama_gudang']) {
                                    ...
                                    <div class="col-md-4" style="padding-bottom: 10px;">
                                        <div class="input-group-prepend">
                                            ...
                                            <input type="month" id="tanggal_home" style="width: 200px;" name="tanggal" value="<?php echo $_SESSION['s_tanggal'];  ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4" style=" padding-bottom: 10px;">
                                        <div class="input-group-prepend">
                                            ...
                                            <select class="custom-select" id="status_bbk" style="width: 200px;" name="status_bbk" required>
                                                <?php
                                                if ($_SESSION['status_bbk'] == 'ALL') {
                                                    echo "<option value ='ALL' selected>ALL</option>";
                                                } else {
                                                    echo "<option value ='ALL'>ALL</option>";
                                                }
                                                ?>
                                                <option value="A" <?php if ($_SESSION['s_status_bbk'] == 'A') {
                                                                        echo 'selected';
                                                                    } ?>>PERLU PERSETUJUAN</option>

                                                <option value="Y" <?php if ($_SESSION['s_status_bbk'] == 'Y') {
                                                                        echo 'selected';
                                                                    } ?>>SUDAH DISETUJUI</option>

                                                <option value="X" <?php if ($_SESSION['s_status_bbk'] == 'X') {
                                                                        echo 'selected';
                                                                    } ?>>DITOLAK</option>
                                            </select>
                                        </div>
                                    ...
                                    <?php if ($level == 'ADMIN') { ?>
                                        <div class="col-md-4" style="padding-top: 10px; padding-bottom: 10px;">
                                            <div class="input-group-prepend">
                                                ...
                                                <select class="custom-select" id="pilih_departemen_bbk" name="pilih_departemen_bbk" style="width: 200px;" required>
                                                    ...
                                                    while ($datacek = $sql1->fetch_assoc()) {
                                                        ...
                                                        if ($_SESSION['s_pilih_departemen_bbk'] == $datacek['nama_departemen']) {
                                    ...
                                    <?php if ($level <> 'USER') { ?>
                                        <div class="col-md-4" style="padding-top: 10px; padding-bottom: 10px;">
                                            <div class="input-group-prepend">
                                                ...
                                                <select class="custom-select" id="pilih_pengguna_bbk" name="pilih_pengguna_bbk" style="width: 200px;" required>
                                                    ...
                                                    if ($_SESSION['s_pilih_pengguna_bbk'] == 'ALL') {
                                                        echo "<option value ='ALL' selected>ALL</option>";
                                                    } else {
                                                        echo "<option value ='ALL'>ALL</option>";
                                                    }
                                                    ...
                                                    $sql1 = $koneksi_master->query("SELECT a.nama FROM pb_role.tb_user a INNER JOIN pb_master.tb_departemen_karyawan b ON a.kode_departemen=b.kode_departemen where a.status='A' AND b.status='A' AND b.nama_departemen='$_SESSION[s_pilih_departemen_bbk]' ORDER BY kode_user ASC");

                                                    while ($datacek = $sql1->fetch_assoc()) {

                                                        if ($_SESSION['s_pilih_pengguna_bbk'] == $datacek['nama']) {
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">DAFTAR BARANG KELUAR
                            <!-- <?php echo $_SESSION['s_pilih_tanggal'] . $_SESSION['s_status_bbk']; ?> (<?php echo $_SESSION['s_pilih_pengguna_bbk'] ?>) (<?php echo $_SESSION['s_pilih_departemen_bbk'] ?>) -->
                        </h3>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            $sqltext = "SELECT a.kode_bbk, a.tanggal_bbk, a.pemohon, a.jabatan, b.nama_gudang, a.status_bbk, c.nik, d.nama_departemen FROM pb_transaksi.tb_bbk a INNER JOIN pb_master.tb_gudang b ON a.kode_gudang=b.kode_gudang INNER JOIN pb_role.tb_user c ON a.nik=c.nik INNER JOIN pb_master.tb_departemen_karyawan d ON c.kode_departemen=d.kode_departemen";
                            ...
                            if ($level == 'SUPERVISOR') {
                                $sqltext = $sqltext . "AND EXISTS(SELECT x.* FROM pb_transaksi.tb_bbk_detail x WHERE x.kode_bbk=a.kode_bbk) AND c.kode_departemen='$kode_departemen' ";
                            }

                            $sqltext = $sqltext . " AND '" .  $_SESSION['s_pilih_gudang'] . "' = b.nama_gudang
                             AND d.nama_departemen = '$_SESSION[s_pilih_departemen]'
                             AND a.tanggal_bbk between '$tgl_awal' and '$tgl_akhir'";

                            // $sqltext = $sqltext . " AND '" .  $_SESSION['s_pilih_tanggal'] . "' = date_format (a.tanggal_bbk,'%Y-%m') 
                            // AND b.nama_gudang ='$_SESSION[s_pilih_gudang]'
                            // AND d.nama_departemen = '$_SESSION[s_pilih_departemen]'";

                            if ($_SESSION['s_pilih_pengguna'] <> 'ALL') {
                                $sqltext = $sqltext . " AND '" . $_SESSION['s_pilih_pengguna'] . "' = a.pemohon";
                            }

                            if ($_SESSION['s_status_permintaan'] <> 'ALL') {
                                $sqltext = $sqltext . " AND '" . $_SESSION['s_status_permintaan'] . "' = a.status_bbk";
                            }
                            ...
                            while ($data = $sql->fetch_assoc()) {
                                ...
                                if ($data['status_bbk'] == 'A') {
                                    $status_bbk = 'Perlu Persetujuan' and $color = 'bg-warning';
                                    ...
                                    $sql_count_status_selain_a = $koneksi_master->query("SELECT COUNT(kode_bbk) 'jumlah' FROM pb_transaksi.tb_bbk_detail WHERE status='A' AND status_bbk<>'A' AND kode_bbk='" . $data['kode_bbk'] . "'");
                                    $tampil_count_status_selain_a = $sql_count_status_selain_a->fetch_assoc();
                                } elseif ($data['status_bbk'] == 'Y') {
                                    $status_bbk = 'Sudah Disetujui' and $color = 'bg-success';
                                    $sql_count_status = $koneksi_master->query("SELECT COUNT(kode_bbk) 'jumlah' FROM pb_transaksi.tb_bbk_detail WHERE status='A' AND status_bbk='Y' AND kode_bbk='" . $data['kode_bbk'] . "'");
                                    $tampil_count_status = $sql_count_status->fetch_assoc();
                                    ...
                                    $status_bbk = 'Ditolak!' and $color = 'bg-danger';
                                    $sql_count_status = $koneksi_master->query("SELECT COUNT(kode_bbk) 'jumlah' FROM pb_transaksi.tb_bbk_detail WHERE status='A' AND status_bbk='N' AND kode_bbk='" . $data['kode_bbk'] . "'");
                                    $tampil_count_status = $sql_count_status->fetch_assoc();
                            ...
                            ?>
                                ...
                                <div class="card col-sm-12 shadow p-2 mb-4 bg-body" style="padding: 4px; background-color:bg-white; border-style: solid; border-width: thin; border-top-left-radius: 50px; border-bottom-right-radius: 50px; background-color: 	#F5F5F5;">
                                    <div class="card-header text-dark text-center" style="border-width: thin; border-top-left-radius: 40px; border-bottom-right-radius: 20px; background-color: <?php echo $bg_color ?>">
                                        <h6><strong><?php echo strtoupper(strftime("%A, %d %B %Y", strtotime($data['tanggal_bbk']))); ?></strong></h6>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <a href="?page=bbk&aksi=detail&kode_bbk=<?php echo $data['kode_bbk']; ?>&pc=<?php echo $angka; ?>&oc=<?php echo md5($data['kode_bbk'] . $angka); ?>" class="btn btn-success" title="Lihat Detail"><i class="fas fa-eye"></i></a>

                                                                <!-- <a onclick="return confirm('Apakah Anda Yakin Ingin Menyetujui Data Ini ?')" href="?page=bbk&aksi=proses_bbk&kode_bbk=<?php echo $data['kode_bbk']; ?>&kode_barang=<?php echo $data['kode_barang']; ?>&pc=<?php echo $angka; ?>&oc=<?php echo md5($data['kode_bbk'] . $angka); ?>" class="btn btn-success"><i class="fas fa-check"></i></a> -->

                                                                <!-- <a onclick="return confirm('Apakah Anda Yakin Ingin Menolak Data Ini ?')" href="?page=bbk&tidak_disetujui&aksi=proses_bbk&kode_bbk=<?php echo $data['kode_bbk']; ?>&kode_barang=<?php echo $data['kode_barang']; ?>&pc=<?php echo $angka; ?>&oc=<?php echo md5($data['kode_bbk'] . $angka); ?>" class="btn btn-danger" ><i class="fas fa-times"></i></a> -->
                                                                ...
                                                                <?php if (($level == 'USER') or ($level == 'ADMIN')) {
                                                                    if ($tampil_count_status_selain_a['jumlah'] == 0) {
                                                                        if (($data['status_bbk'] == 'A') and ($_SESSION['s_nik'] == $data['nik'])) { ?>
                                                                            <a onclick="return confirm('Apakah Anda Yakin Ingin Menghapus ke- <?php echo $tampil_count_status['jumlah'] ?> Barang Ini?')" href="?page=bbk&aksi=hapus&kode_bbk=<?php echo $data['kode_bbk']; ?>&pc=<?php echo $angka; ?>&oc=<?php echo md5($data['kode_bbk'] . $angka); ?>" class="btn btn-danger" title="Hapus Data"><i class="fas fa-trash"></i></a>

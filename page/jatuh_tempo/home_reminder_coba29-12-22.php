        ...
        <div class="card card-primary">
          <div class="card-header">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <?php
                  $sqltext = "SELECT distinct a.kode_aktiva, b.deskripsi_aktiva, a.kode_trxtype from pb_transaksi.tb_aktiva_detail a inner join pb_transaksi.tb_aktiva b on a.kode_aktiva=b.kode_aktiva";
                  ...
                  // if ($_SESSION['s_pilih_jatuh'] <> 'ALL') {
                  //     $sqltext = $sqltext . " AND '" . $_SESSION['s_pilih_jatuh'] . "' = a.kode_trxtype ";
                  // }
                  $sqlpaging = $sqltext;
                ...
                <?php
                  while ($data = $sql->fetch_assoc()) {
                    ...
                    $tampil_jatuh_tempo_polis = $sql_jatuh_tempo_polis->fetch_assoc();
                     ...
                     // SQL untuk ALL
                     $sql_jatuh_all = $koneksi_master->query("SELECT * from pb_master.tb_mapping_reminder a inner join pb_master.tb_trxtype b on a.kode_trxtype=b.kode_trxtype inner join pb_transaksi.tb_aktiva_detail c on a.kode_trxtype = c.kode_trxtype where a.status='A' and b.status='A' and c.kode_aktiva='".$data['kode_aktiva']."'");
                     $tampil_jatuh_all = $sql_jatuh_all->fetch_assoc();
                     
                    // $sql_jatuh_tempo_polis = $sql_jatuh_tempo_polis . "ORDER BY a.tgl_jatuh_tempo ASC";
                    

                    // $sql_jatuh = $koneksi_master->query("SELECT * from pb_master.tb_mapping_reminder a inner join pb_master.tb_trxtype b on a.kode_trxtype=b.kode_trxtype inner join pb_transaksi.tb_aktiva_detail c on a.kode_trxtype = c.kode_trxtype where a.kode_trxtype= '".$_SESSION['s_pilih_jatuh']."' and a.status='A' and b.status='A' and c.kode_aktiva='".$data['kode_aktiva']."' ");
                    // // $sql_jatuh = $sql_jatuh . "ORDER BY a.tgl_jatuh_tempo ASC";
                    // $tampil_jatuh = $sql_jatuh->fetch_assoc();
                ...
                <div class="card col-sm-4 shadow p-2 mb-4 bg-body" style="padding: 4px; background-color:bg-white; border-style: solid; border-width: thin; border-top-left-radius: 50px; border-bottom-right-radius: 50px; 
                border-block-width: 4px; writing-mode: horizontal-tb; direction: rtl;
                background-color: #F5F5F5;">
                <?php } ?>
                    <!--  -->

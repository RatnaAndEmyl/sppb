                ...
                <div class="row">
                  ...
                  <div class="col-md-4" style=" padding-bottom: 10px; ">
                    <div class="input-group-prepend">
                      ...
                      <select class="custom-select" id="pilih_jatuh" name="pilih_jatuh" style="width: 170px;" required>
                        <?php
...
<!-- UNTUK MENGATUR CARD JIKA ALL MAKA LEBIH PENDEK -->
              <?php if ($_SESSION['s_pilih_pengguna_mobil'] <> 'ALL') { ?>
                        <div class="card col-sm-12 shadow p-2 mb-4 bg-body"
                        style="padding: 4px; background-color:bg-white; border-style: solid; border-width: thin; border-top-left-radius: 50px; border-bottom-right-radius: 50px; 
                        border-block-width: 4px; writing-mode: horizontal-tb; direction: rtl;
                        background-color: #F5F5F5;">

              <?php } else { ?> 

                      <div class="card col-sm-4 shadow p-2 mb-4 bg-body"
                      style="padding: 4px; background-color:bg-white; border-style: solid; border-width: thin; border-top-left-radius: 50px; border-bottom-right-radius: 50px; 
                      border-block-width: 4px; writing-mode: horizontal-tb; direction: rtl;
                      background-color: #F5F5F5;">
              <?php } ?> 
<!--  -->
          ...
          <div class="card-header text-dark text-center"
            style="border-width: thin; border-top-left-radius: 40px; border-bottom-right-radius: 20px; border-inline: 1rem solid; writing-mode: horizontal-tb; direction: rtl; 
...
<?php if ($tampil_foto['file'] == (strtoupper(substr($tampil_foto['file'], -3)) <> 'JPG' and strtoupper(substr($tampil_foto['file'], -4)) <> 'JPEG' and strtoupper(substr($tampil_foto['file'], -3)) <> 'PNG')) { ?>
  ...
  <?php } else { ?>
    ...
    <a data-toggle="modal"
      data-target=<?php echo "#exampleModalPersetujuan" . $tampil_foto ['tgl_create']; ?>>View Foto</a>

    <a href="download.php?filename=<?= $tampil_foto ['file'] ?>">Download</a>

<div class="modal fade" id=<?php echo "exampleModalPersetujuan" . $tampil_foto ['tgl_create']; ?>
                        ...
                        <div class="col-md-12" style="text-align:center">
                          <div class="form-group row">
                            ...
                            <div class="col-md-12">
                              ...
                              <a href="?page=jatuh_tempo&aksi=p_detail_dashboard&kode_trxtype=<?php echo $_SESSION['s_pilih_jatuh']; ?>&kode_aktiva=<?php echo $data['kode_aktiva']; ?>&pc=<?php echo $angka; ?>&oc=<?php echo md5($_SESSION['s_pilih_jatuh'] . $angka); ?>"class="btn btn-warning "><i class="fa fa-bell"></i></a>
                              <a href="?page=jatuh_tempo&aksi=detail_dashboard&kode_trxtype=<?php echo $_SESSION['s_pilih_jatuh']; ?>&kode_aktiva=<?php echo $data['kode_aktiva']; ?>&pc=<?php echo $angka; ?>&oc=<?php echo md5($_SESSION['s_pilih_jatuh'] . $angka); ?>"class="btn btn-success "><i class="fas fa-eye"></i></a>

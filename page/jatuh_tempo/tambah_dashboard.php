                ...
                <form method="POST" action="?page=jatuh_tempo&aksi=tambah_proses" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <select class="form-control" name="kode_aktiva" id="kode_aktiva" readonly>
                        <?php
                          if ($kode_trxtype == 'TRX000014') {
                              ...
                              WHERE a.STATUS='A' and b.STATUS='A' and b.kode_trxtype='TRX000004' and b.kode_aktiva='$kode_aktiva' ORDER BY a.kode_aktiva");
                  ...
                  <div class="form-group">
                    ...
                    <input type="month" class="form-control" name="periode_awal" min="<?php echo $tanggal_p;?>" placeholder="Masukan periode awal"
                      required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail111"> Periode Akhir</label>
                    <input type="month" class="form-control" name="periode_akhir" min="<?php echo $tanggal_p;?>" placeholder="Masukan periode akhir"
                      required>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="tgl_jatuh_tempo" min="<?php echo $tanggal_awal;?>" required>
                  </div>
                  <?php }?>
                  <div class="form-group">

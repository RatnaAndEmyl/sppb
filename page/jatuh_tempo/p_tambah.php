                ...
                <form method="POST" action="?page=jatuh_tempo&aksi=p_tambah_proses" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <select class="form-control select2" name="kode_aktiva" id="jatuh_tempo">
                        <?php
                  ...
                  <a href="?page=home&halaman=1" class="btn btn-dark" class="btn btn-dark">Kembali</a>
                  
                  <!-- <a href="?page=jatuh_tempo&aksi=p_detail&kode_trxtype=<?php echo $kode_trxtype; ?>&pc=<?php echo $angka; ?>&oc=<?php echo md5($kode_trxtype . $angka); ?>" class="btn btn-dark" class="btn btn-dark">Kembali</a> -->

...
$sqltext = "UPDATE pb_transaksi.tb_pengingat SET status_reminder ='AKTIF', update_by='$kode_user' WHERE kode_pengingat='$kode_pengingat' and kode_trxtype='$kode_trxtype'";

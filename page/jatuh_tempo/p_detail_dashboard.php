    ...
    <div class="row">
      <div class="col-12">
        <div class="card card-primary">
          ...
          <div class="card-body">
            <a href="?page=home&halaman=1" class="btn btn-success" style="margin-bottom: 5px; "><i class="fa fa-arrow-circle-down"></i> Simpan All</a>
                <!--  -->
        ...
        <div class="card card-primary">
          ...
          <div class="card-body">
            <a href="?page=jatuh_tempo&aksi=p_tambah_dashboard&kode_trxtype=<?php echo $kode_trxtype; ?>&kode_aktiva=<?php echo $kode_aktiva; ?>&pc=<?php echo $angka; ?>&oc=<?php echo md5($kode_trxtype . $angka); ?>"
              class="btn btn-info" style="margin-bottom: 5px; "><i class="fas fa-plus-circle"></i> Tambah Data</a>
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <?php
                        ...
                        where a.status='A' and kode_trxtype='$kode_trxtype' and b.kode_aktiva = '$kode_aktiva' order by end");

...
if ($value == 'in') {
    $sql_history = "INSERT INTO pb_transaksi.tb_history_stok values('$kode_adjustment','$kode_gudang_new','$kode_barang','$nama_barang','$username_new',null,'ADJ IN','$stok_akhir_new','$stok_in','$stok_keluar','$stok_akhir_stok','A',null,'$kode_user',null,null,null,null)";
} else {
    $sql_history = "INSERT INTO pb_transaksi.tb_history_stok values('$kode_adjustment','$kode_gudang_new','$kode_barang','$nama_barang','$username_new',null,'ADJ OUT','$stok_akhir_new','$stok_masuk','$stok_out','$stok_akhir_stok','A',null,'$kode_user',null,null,null,null)";
}

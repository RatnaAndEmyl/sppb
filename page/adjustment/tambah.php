...
// $tanggal_adjustment = date('Y-m-d H:i:s');
      ...
      <div class="col-12">
        <div class="card card-primary">
          <div class="card-header">
            <h4 class="card-title">Tambah Adjustment</h4>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col-sm-12 col-xs-12">
                <form method="POST" action="?page=adjustment&aksi=tambah_proses" enctype="multipart/form-data">
                  <div class="form-group">
                    <label for="exampleInputEmail111">Nama Operator</label>
                    <input type="text" class="form-control" name="username" readonly value="<?php echo $nama ?>">
                  </div>
                  ...
                  <div class="form-group">
                    <label>Unggah Berita Acara</label>
                    <input type="file" name="file" class="form-control" required>
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail111">Tanggal adjustment</label>
                    <input type="date" class="form-control" id="txtdateofreservation" readonly value="<?php echo $tanggal_adjustment ?>" name="tanggal_adjustment" required>
                  </div>
                  ...
                  <a href="?page=adjustment&aksi=home_adjustment" class="btn btn-dark">Kembali</a>

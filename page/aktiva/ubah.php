        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-sm-12 col-xs-12">
              <form method="POST" action="?page=aktiva&aksi=ubah_proses" name="autoSumForm">

                <div class="form-group">
                  <label for="exampleInputEmail111">Kode Aktiva</label>
                  <input type="text" class="form-control" name="kode_aktiva"
                    value="<?php echo $tampil['kode_aktiva']; ?>" readonly>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="deskripsi_aktiva"
                    value="<?php echo $tampil['deskripsi_aktiva']; ?>" required>
                </div>

                <div>
                  <input type="submit" value="Simpan" name="simpan" class="btn btn-success m-r-10">
                  <a href="?page=aktiva" class="btn btn-dark">Kembali</a>
                </div>
              </form>

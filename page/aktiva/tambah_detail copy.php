                        ...
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" readonly value="<?php echo $kode_aktiva ?>" name="kode_aktiva">
                                    </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <?php
                                                ...
                                                $sql1 = $koneksi_master->query("SELECT * FROM pb_master.tb_trxtype a where a.status='A' and exists(select * from pb_master.tb_mapping_master x inner join pb_master.tb_mapping_detail y on x.kode_mapping_master=y.kode_mapping_master where x.kode_subkategori='$kode_subkategori' and x.status='A' and a.kode_trxtype=y.kode_trxtype )  ");

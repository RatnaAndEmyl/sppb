          ...
          <div class="card-body">
            <div class="row">
              <div class="col-sm-12 col-xs-12">
                <form method="POST" action="?page=permintaan&aksi=tambah_proses" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="tanggal" placeholder="tanggal" value="<?php echo $tanggal; ?>" required readonly>
                  </div>
                  <div class="form-group">

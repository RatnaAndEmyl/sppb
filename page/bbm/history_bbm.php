            ...
            <div class="col-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h4 class="card-title">HISTORY BARANG MASUK</h4> <br>
                        <?php echo $tampil_jumlah_permintaan['jumlah_permintaan']; ?>
                    </div>
                    <div class="card-body">

                        <a href="?page=bbm" class="btn btn-dark" style="margin-bottom: 5px; "><i class="fa fa-undo"></i> Kembali</a>

                        <a href="?page=bbm&aksi=home_bbm" class="btn btn-secondary" style="margin-bottom: 5px; "><i class="fas fa-home"></i> Home BBM</a>
                                    ...
                                    <table id="example1" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" style="text-align:center; vertical-align:middle;">Tanggal BBM</th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $no = 1;
                                            $TextQuery = "SELECT a.kode_bbm, a.tanggal_bbm, c.nama, a.jabatan, b.nama_gudang, a.status_bbm, a.create_by FROM pb_transaksi.tb_bbm a 
                                            ...
                                            if ($level == 'USER') {
                                                ...
                                                $TextQuery = "SELECT a.kode_bbm, a.tanggal_bbm, c.nama, a.jabatan, b.nama_gudang, a.status_bbm, a.create_by FROM pb_transaksi.tb_bbm a INNER JOIN pb_master.tb_gudang b ON a.kode_gudang=b.kode_gudang INNER JOIN pb_role.tb_user c ON a.nik=c.nik INNER JOIN (SELECT x.kode_bbm, COUNT(x.kode_bbm) AS 'jumlah' FROM pb_transaksi.tb_bbm_detail x WHERE x.status <> 'N' GROUP BY x.kode_bbm ORDER BY x.kode_bbm)xx ON a.kode_bbm = xx.kode_bbm WHERE a.status='A' AND xx.jumlah > 0 AND c.kode_departemen='$kode_departemen'";
                                            }
                                                    ...
                                                    if ($tampil_count_status['jumlah'] <> 0) { ?>
                                                        <tr>
                                                            ...
                                                            <td style="text-align:center; vertical-align:middle;">
                                                                ...
                                                                <?php if (($tampil_count_status['jumlah'] <> 0) and ($_SESSION['s_kode_user'] == $data['create_by']) and ($data['status_bbm'] <> 'XX')) { ?>
                                                                    <a href="?page=bbm&aksi=hangus_bbm&kode_bbm=<?php echo $data['kode_bbm']; ?>&pc=<?php echo $angka; ?>&oc=<?php echo md5($data['kode_bbm'] . $angka); ?>" class="btn btn-dark" title="Hanguskan Data"><i class="fa fa-sign-language"></i></a>
                                                                <?php  } ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="text-align:center; vertical-align:middle;">
                                                                <?php echo $no++; ?></td>
                                                            <td style="text-align:center; vertical-align:middle;">
                                                                <?php echo $tampil_count['jumlah']; ?> - <?php echo $data['kode_bbm']; ?></td>
                                                            <td style="text-align:center; vertical-align:middle;">
                                                                <?php echo strftime("%d %B %Y", strtotime($data['tanggal_bbm'])); ?></td>
                                                            <td style="text-align:center; vertical-align:middle;">
                                                                <?php echo $data['nama']; ?> <br>

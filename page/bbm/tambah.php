          ...
          <div class="card-body">
            <div class="row">
              <div class="col-sm-12 col-xs-12">
                <form method="POST" action="?page=bbm&aksi=tambah_proses" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="tanggal_bbm" readonly value="<?php echo $tanggal_bbm ?>" required>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <select class="form-control" name="kode_suplier" id="cari_nama" required>

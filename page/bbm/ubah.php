        ...
        <div class="col-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h4 class="card-title">Daftar BBM
                        <?php echo $nama ?>
                        (<?php echo $jabatan; ?>)
                    </h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-5 align-self-center">
                            <h4 class="page-title">Ubah BBM</h4>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-xs-12">
                            <form method="POST" action="?page=bbm&aksi=ubah_proses" name="autoSumForm">

                                <div class="form-group">
                                    <label for="exampleInputEmail111">Kode bbm</label>
                                    <input type="text" class="form-control" name="kode_bbm" value="<?php echo $tampil['kode_bbm']; ?>" readonly>
                                </div>
                                <!-- <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail111">Tanggal BBM</label>
                                    <input type="date" class="form-control" id="txtdateofreservation" name="tanggal_bbm" value="<?php echo $tampil['tanggal_bbm']; ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" name="kode_user" id="cari_nama"  value="<?php echo $tampil['kode_user']; ?>" required>
                                            <?php
                                ...
                                <div>
                                    ...
                                    <a href="?page=bbm" class="btn btn-dark">Kembali</a>
                                </div>
                            </form>
                        </div>
                    </div>

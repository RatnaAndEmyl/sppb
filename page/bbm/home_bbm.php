        ...
        <div class="row">
            <div class="col-12">
                ...
                <!-- <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="table-resbbmnsive" style="padding-left:20px;padding-right:20px;padding-bottom:20px;padding-top:20px;">
                                <div class="row">
                                    ...
                                    <div class="col-md-4" style=" padding-bottom: 10px;">
                                        <div class="input-group-prepend">
                                            ...
                                            <select class="custom-select" id="pilih_gudang_bbm" name="pilih_gudang_bbm" style="width: 200px;" required>
                                                ...
                                                while ($datacek = $sql1->fetch_assoc()) {
                                                    ...
                                                    if ($_SESSION['s_pilih_gudang_bbm'] == $datacek['nama_gudang']) {
                                    ...
                                    <div class="col-md-4" style="padding-bottom: 10px;">
                                        <div class="input-group-prepend">
                                            ...
                                            <input type="month" id="tanggal_bbm" style="width: 200px;" name="tanggal" value="<?php echo $_SESSION['s_tanggal_bbm'];  ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4" style=" padding-bottom: 10px;">
                                        <div class="input-group-prepend">
                                            ...
                                            <select class="custom-select" id="status_bbm" style="width: 200px;" name="status_bbm" required>
                                                <?php
                                                if ($_SESSION['status_bbm'] == 'ALL') {
                                                    echo "<option value ='ALL' selected>ALL</option>";
                                                } else {
                                                    echo "<option value ='ALL'>ALL</option>";
                                                }
                                                ?>
                                                <option value="A" <?php if ($_SESSION['s_status_bbm'] == 'A') {
                                                                        echo 'selected';
                                                                    } ?>>PERLU PERSETUJUAN</option>

                                                <option value="Y" <?php if ($_SESSION['s_status_bbm'] == 'Y') {
                                                                        echo 'selected';
                                                                    } ?>>SUDAH DISETUJUI</option>

                                                <option value="X" <?php if ($_SESSION['s_status_bbm'] == 'X') {
                                                                        echo 'selected';
                                                                    } ?>>DITOLAK</option>
                                            </select>
                                        </div>
                                    ...
                                    <?php if ($level == 'ADMIN') { ?>
                                        <div class="col-md-4" style="padding-top: 10px; padding-bottom: 10px;">
                                            <div class="input-group-prepend">
                                                ...
                                                <select class="custom-select" id="pilih_departemen_bbm" name="pilih_departemen_bbm" style="width: 200px;" required>
                                                    ...
                                                    while ($datacek = $sql1->fetch_assoc()) {
                                                        ...
                                                        if ($_SESSION['s_pilih_departemen_bbm'] == $datacek['nama_departemen']) {
                                    ...
                                    <?php if ($level <> 'USER') { ?>
                                        <div class="col-md-4" style="padding-top: 10px; padding-bottom: 10px;">
                                            <div class="input-group-prepend">
                                                ...
                                                <select class="custom-select" id="pilih_pengguna_bbm" name="pilih_pengguna_bbm" style="width: 200px;" required>
                                                    ...
                                                    if ($_SESSION['s_pilih_pengguna_bbm'] == 'ALL') {
                                                        echo "<option value ='ALL' selected>ALL</option>";
                                                    } else {
                                                        echo "<option value ='ALL'>ALL</option>";
                                                    }
                                                    ...
                                                    $sql1 = $koneksi_master->query("SELECT a.nama FROM pb_role.tb_user a INNER JOIN pb_master.tb_departemen_karyawan b ON a.kode_departemen=b.kode_departemen where a.status='A' AND b.status='A' AND b.nama_departemen='$_SESSION[s_pilih_departemen_bbm]' ORDER BY kode_user ASC");

                                                    while ($datacek = $sql1->fetch_assoc()) {

                                                        if ($_SESSION['s_pilih_pengguna_bbm'] == $datacek['nama']) {
                                    ...
                                    <?php if ($level <> 'USER') { ?>
                                        <div class="col-md-4" style="padding-top: 10px; padding-bottom: 10px;">
                                            <div class="input-group-prepend">
                                                <label class="input-group-text" for="inputGroupSelect01" style="font-weight: bold; width: 110px; text-align:right;">Suplier</label>
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">DAFTAR BARANG MASUK
                            <!-- <?php echo $_SESSION['s_pilih_tanggal'] . $_SESSION['s_status_bbm']; ?> (<?php echo $_SESSION['s_pilih_pengguna_bbm'] ?>) (<?php echo $_SESSION['s_pilih_departemen_bbm'] ?>) (<?php echo $_SESSION['s_pilih_suplier_bbm'] ?>) (<?php echo $_SESSION['s_pilih_gudang_bbm'] ?>) -->
                        </h3>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            $sqltext = "SELECT a.kode_bbm, a.tanggal_bbm, a.username, a.jabatan, b.nama_gudang, a.status_bbm, c.nik, d.nama_departemen, e.nama_suplier FROM pb_transaksi.tb_bbm a INNER JOIN pb_master.tb_gudang b ON a.kode_gudang=b.kode_gudang INNER JOIN pb_role.tb_user c ON a.nik=c.nik INNER JOIN pb_master.tb_departemen_karyawan d ON c.kode_departemen=d.kode_departemen INNER JOIN pb_master.tb_suplier e ON a.kode_suplier=e.kode_suplier";
                            ...
                            if ($level == 'SUPERVISOR') {
                                $sqltext = $sqltext . "AND EXISTS(SELECT x.* FROM pb_transaksi.tb_bbm_detail x WHERE x.kode_bbm=a.kode_bbm) AND c.kode_departemen='$kode_departemen' ";
                            }

                            $sqltext = $sqltext . " AND '" .  $_SESSION['s_pilih_gudang'] . "' = b.nama_gudang
                            AND d.nama_departemen = '$_SESSION[s_pilih_departemen]'
                            AND a.tanggal_bbm between '$tgl_awal' and '$tgl_akhir'";

                            // $sqltext = $sqltext . " AND '" .  $_SESSION['s_pilih_tanggal'] . "' = date_format (a.tanggal_bbm,'%Y-%m') 
                            // AND b.nama_gudang ='$_SESSION[s_pilih_gudang]'
                            // AND d.nama_departemen = '$_SESSION[s_pilih_departemen]'";

                            if ($_SESSION['s_pilih_suplier_bbm'] <> 'ALL') {
                                $sqltext = $sqltext . " AND '" . $_SESSION['s_pilih_suplier_bbm'] . "' = e.nama_suplier";
                            }

                            if ($_SESSION['s_status_permintaan'] <> 'ALL') {
                                $sqltext = $sqltext . " AND '" . $_SESSION['s_status_permintaan'] . "' = a.status_bbm";
                            }
                            ...
                            <div class="col-sm-12" style="text-align:<?php echo $bbmsisi ?>; padding-bottom:10px;">
                                <?php
                                if ($JumlahData > 0) { ?>
                            ...
                            while ($data = $sql->fetch_assoc()) {
                                ...
                                if ($data['status_bbm'] == 'A') {
                                    $status_bbm = 'Perlu Persetujuan' and $color = 'bg-warning';
                                    ...
                                    $sql_count_status_selain_a = $koneksi_master->query("SELECT COUNT(kode_bbm) 'jumlah' FROM pb_transaksi.tb_bbm_detail WHERE status='A' AND status_bbm<>'A' AND kode_bbm='" . $data['kode_bbm'] . "'");
                                    $tampil_count_status_selain_a = $sql_count_status_selain_a->fetch_assoc();
                                } elseif ($data['status_bbm'] == 'Y') {
                                    $status_bbm = 'Sudah Disetujui' and $color = 'bg-success';
                                    $sql_count_status = $koneksi_master->query("SELECT COUNT(kode_bbm) 'jumlah' FROM pb_transaksi.tb_bbm_detail WHERE status='A' AND status_bbm='Y' AND kode_bbm='" . $data['kode_bbm'] . "'");
                                    $tampil_count_status = $sql_count_status->fetch_assoc();
                                    ...
                                    $status_bbm = 'Ditolak!' and $color = 'bg-danger';
                                    $sql_count_status = $koneksi_master->query("SELECT COUNT(kode_bbm) 'jumlah' FROM pb_transaksi.tb_bbm_detail WHERE status='A' AND status_bbm='N' AND kode_bbm='" . $data['kode_bbm'] . "'");
                                    $tampil_count_status = $sql_count_status->fetch_assoc();
                                    ...
                                    $status_bbm = 'Hangus' and $color = 'bg-dark';
                                    $sql_count_status = $koneksi_master->query("SELECT COUNT(kode_bbm) 'jumlah' FROM pb_transaksi.tb_bbm_detail WHERE status='A' AND status_bbm='XX' AND kode_bbm='" . $data['kode_bbm'] . "'");
                                    $tampil_count_status = $sql_count_status->fetch_assoc();
                                    $status = 'Barang Hangus' and $colortext = 'text-dark';
                            ...
                            ?>
                                ...
                                <div class="card col-sm-12 shadow p-2 mb-4 bg-body" style="padding: 4px; background-color:bg-white; border-style: solid; border-width: thin; border-top-left-radius: 50px; border-bottom-right-radius: 50px; background-color: 	#F5F5F5;">
                                    <div class="card-header text-dark text-center" style="border-width: thin; border-top-left-radius: 40px; border-bottom-right-radius: 20px; background-color: <?php echo $bg_color ?>">
                                        <h6><strong><?php echo strtoupper(strftime("%A, %d %B %Y", strtotime($data['tanggal_bbm']))); ?></strong></h6>
                                        ...
                                        <div class="form-body">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="control-label text-left col-md-3">Suplier</label>
                                                            <div class="col-md-6">
                                                                <?php echo $data['nama_suplier']; ?><br>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                } else if ($status == 'Barang Ditolak') {
                                                                    $warna_status = 'badge badge-pill badge-danger';
                                                                } else {
                                                                    $warna_status = 'badge badge-pill badge-dark';
                                                                } ?>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <a href="?page=bbm&aksi=detail&kode_bbm=<?php echo $data['kode_bbm']; ?>&pc=<?php echo $angka; ?>&oc=<?php echo md5($data['kode_bbm'] . $angka); ?>" class="btn btn-success" title="Lihat Detail"><i class="fas fa-eye"></i></a>

                                                                <!-- <a onclick="return confirm('Apakah Anda Yakin Ingin Menyetujui Data Ini ?')" href="?page=bbm&aksi=proses_bbm&kode_bbm=<?php echo $data['kode_bbm']; ?>&kode_barang=<?php echo $data['kode_barang']; ?>&pc=<?php echo $angka; ?>&oc=<?php echo md5($data['kode_bbm'] . $angka); ?>" class="btn btn-success"><i class="fas fa-check"></i></a> -->

                                                                <!-- <a onclick="return confirm('Apakah Anda Yakin Ingin Menolak Data Ini ?')" href="?page=bbm&tidak_disetujui&aksi=proses_bbm&kode_bbm=<?php echo $data['kode_bbm']; ?>&kode_barang=<?php echo $data['kode_barang']; ?>&pc=<?php echo $angka; ?>&oc=<?php echo md5($data['kode_bbm'] . $angka); ?>" class="btn btn-danger" ><i class="fas fa-times"></i></a> -->
                                                                ...
                                                                <?php if (($level == 'USER') or ($level == 'ADMIN')) {
                                                                    if ($tampil_count_status_selain_a['jumlah'] == 0) {
                                                                        if (($data['status_bbm'] == 'A') and ($_SESSION['s_nik'] == $data['nik'])) { ?>
                                                                            <a onclick="return confirm('Apakah Anda Yakin Ingin Menghapus ke- <?php echo $tampil_count_status['jumlah'] ?> Barang Ini?')" href="?page=bbm&aksi=hapus&kode_bbm=<?php echo $data['kode_bbm']; ?>&pc=<?php echo $angka; ?>&oc=<?php echo md5($data['kode_bbm'] . $angka); ?>" class="btn btn-danger" title="Hapus Data"><i class="fas fa-trash"></i></a>

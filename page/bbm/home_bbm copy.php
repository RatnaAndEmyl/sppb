            ...
            <div class="col-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">DAFTAR BBM
                            <!-- <?php echo $_SESSION['s_pilih_tanggal'] . $_SESSION['s_status_bbm']; ?> (<?php echo $_SESSION['s_pilih_pengguna_bbm'] ?>) (<?php echo $_SESSION['s_pilih_departemen_bbm'] ?>) -->
                        </h3>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <?php
                            $sqltext = "SELECT a.kode_bbm, a.tanggal_bbm, a.username, a.jabatan, b.nama_gudang, a.status_bbm, c.nik, e.nama_suplier FROM pb_transaksi.tb_bbm a INNER JOIN pb_master.tb_gudang b ON a.kode_gudang=b.kode_gudang INNER JOIN pb_role.tb_user c ON a.nik=c.nik INNER JOIN pb_master.tb_departemen_karyawan d ON c.kode_departemen=d.kode_departemen INNER JOIN pb_master.tb_suplier e ON a.kode_suplier=e.kode_suplier";
                            ...
                            $sqltext = $sqltext . " AND '" .  $_SESSION['s_tanggal_bbm'] . "' = date_format (a.tanggal_bbm,'%Y-%m') 
                            AND b.nama_gudang ='$_SESSION[s_pilih_gudang_bbm]'
                            AND d.nama_departemen = '$_SESSION[s_pilih_departemen_bbm]'";

                            if ($_SESSION['s_pilih_suplier_bbm'] <> 'ALL') {
                                $sqltext = $sqltext . " AND '" . $_SESSION['s_pilih_suplier_bbm'] . "' = e.nama_suplier";
                            }

                            if ($_SESSION['s_status_bbm'] <> 'ALL') {
                                $sqltext = $sqltext . " AND '" . $_SESSION['s_status_bbm'] . "' = a.status_bbm";
                            }

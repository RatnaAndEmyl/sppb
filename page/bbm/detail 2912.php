                                    ...
                                    <table id="example1" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" style="text-align:center; vertical-align:middle;">Keterangan BBM</th>
                                        ...
                                        <tbody>
                                            ...
                                            $sql = $koneksi_master->query("SELECT DISTINCT * FROM pb_transaksi.tb_bbm_detail a INNER JOIN pb_transaksi.tb_bbm b ON a.kode_bbm=b.kode_bbm INNER JOIN pb_master.tb_suplier c ON b.kode_suplier=c.kode_suplier WHERE a.STATUS='A' AND b.STATUS='A' AND c.STATUS='A' AND a.kode_bbm='$kode_bbm' ORDER BY a.kode_bbm asc"); 
                                            //inner join ke tb bbm sama suplier tu untuk menampilkan nama suplier.

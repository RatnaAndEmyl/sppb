                                ...
                                <form method="POST" action="?page=sppb&aksi=tambah_sppb_proses" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control" name="kode_barang" id="cari_nama_barang_sppb" required>
                                                <?php
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="txtdateofreservation" name="jumlah_permintaan" placeholder="Jumlah Permintaan Barang" required>
                                    </div>

            ...
            <div class="col-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">DAFTAR PERMINTAAN BARANG <?php echo $_SESSION['s_pilih_tanggal'] . $_SESSION['s_status_permintaan']; ?> (<?php echo $_SESSION['s_pilih_pengguna'] ?>) (<?php echo $_SESSION['s_pilih_departemen'] ?>)</h3>
                    </div>
                    <div class="card-body">
                        <?php if ($level <> 'SUPERVISOR') { ?>
                            <a href="?page=permintaan&aksi=tambah" class="btn btn-primary" style="margin-bottom: 5px; "><i class="fas fa-plus-circle"></i> Tambah Data</a>
                        <?php } ?>
                        ...
                        <div class="row">
                            ...
                            AND '" . $_SESSION['s_pilih_departemen'] . "' = d.nama_departemen ORDER BY a.tgl_create DESC LIMIT "  . $limitStart . "," . $limit;
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <b><?php echo $data['nama_gudang']; ?><br></b>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <b class=<?php echo $colortext ?>><?php echo $tampil_count_status['jumlah'] ?> <?php echo $status ?></b>

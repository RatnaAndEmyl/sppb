                                        ...
                                        <div class="col-md-6" style="padding-bottom: 10px;">
                                            <div class="input-group-prepend">
                                                ...
                                                <select class="custom-select" id="pilih_barang_history" name="pilih_barang_history" style="width: 300px;" required>
                                                    ...
                                                    $sql1 = $koneksi_master->query("SELECT DISTINCT b.nama_barang, c.nama_gudang FROM pb_master.tb_barang a INNER JOIN pb_transaksi.tb_history_stok b ON a.id_barang=b.kode_barang INNER JOIN pb_master.tb_gudang c ON c.kode_gudang=b.kode_gudang WHERE a.status='A' AND b.status='A' AND c.status='A' AND c.nama_gudang='$_SESSION[s_pilih_gudang_history]' ORDER BY nama_barang ASC");
                                                    // ini menampilkan barang berdasarkan session gudang yng dipilih
                    ...
                    <div class="card card-light collapsed-card">
                        <div class="card-header">
                            <h3 class="card-title">
                                ...
                                &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp<button type="button" class="btn btn-success"></button> Barang Keluar <br><br>
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            $sqltext = $sqltext . " AND '" .  $_SESSION['s_pilih_gudang_history'] . "' = b.nama_gudang";
                            ...
                            <div class="col-sm-12" style="text-align:<?php echo $posisi ?>; padding-bottom:10px;">
                                ...
                                if ($JumlahData > 0) { ?>
                                    ...
                                    ?>
                                        <!-- link Previous Page -->
                                        <a class="btn btn-outline-primary" style="margin:2px;" href="?page=home&aksi=home_history_stok&halaman=<?php echo $LinkPrev; ?>">Prev</a>
                                    <?php
                                    }
                                    ?>
                                    <?php
                                    ...
                                    if ($halaman > $jumlahPage + 1) { ?><script>
                                            window.location.href = "?page=home&aksi=home_history_stok&halaman=1";
                                                ...
                                                for ($i = $startNumber; $i <= $endNumber; $i++) {
                                                    ...
                                                    ?>
                                        <a class=<?php echo $linkActive; ?> style="margin:2px;" href="?page=home&aksi=home_history_stok&halaman=<?php echo $i; ?>"><?php echo $i; ?></a>
                                    <?php
                                                }
                                    ?>
                                    ...
                                    ?>
                                        <a class="btn btn-outline-primary" style="margin:2px;" href="?page=home&aksi=home_history_stok&halaman=<?php echo $linkNext; ?>">Next</a>
                                    <?php
                                    }
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" style="text-align:center; vertical-align:middle;">Admin</th>
                                            <th scope="col" style="text-align:center; vertical-align:middle;">Modul</th>
                                            <th scope="col" style="text-align:center; vertical-align:middle;">Stok Awal</th>
                                            ...
                                            <th scope="col" style="text-align:center; vertical-align:middle;">Stok Akhir</th>
                                        </tr>
                                    </thead>
                            ...
                            while ($data = $sql->fetch_assoc()) {
                                ...
                                } elseif ($data['jenis_modul'] == 'ADJ OUT') {
                            ...
                            ?>
                                ...
                                <tr>
                                    <td style="text-align:center; vertical-align:middle;">
                                        <?php echo $no++; ?></td>
                                    <td style="text-align:center; vertical-align:middle;">
                                        <?php echo strftime("%d %B %Y", strtotime($data['tgl_create'])); ?><br>
                                        <b>(<?php echo strftime("%H:%M:%S", strtotime($data['tgl_create'])); ?>)</b>

                                        <!-- (<?php echo strftime("%I:%M:%S %p", strtotime($data['tgl_create'])); ?>) -->
                                        <!-- format phyton %H & %I  itu menampilkan jam, tetapi %H dengan format 24 jam, sedangkan %I formatnya 12 jam. Sedangkan %p untuk menampilkan AM or PM-->
                                    </td>
                                    <td style="text-align:center; vertical-align:middle;">
                                        <?php echo $data['kode']; ?></td>
                                    <td style="text-align:center; vertical-align:middle;">
                                    ...
                                    <td style="text-align:center; vertical-align:middle;">
                                        <?php if ($data['jenis_modul'] == 'BBM') {
                                            $warna_status = 'badge rounded-pill bg-warning';
                                        } else if ($data['jenis_modul'] == 'BBK') {
                                            $warna_status = 'badge rounded-pill bg-success';
                                        } else if ($data['jenis_modul'] == 'ADJ IN') {
                                            $warna_status = 'badge rounded-pill bg-primary';
                                        } else if ($data['jenis_modul'] == 'ADJ OUT') {
                                            $warna_status = 'badge rounded-pill bg-dark';
                                        } ?>
                                        <h5><span class="<?php echo $warna_status; ?>"><?php echo $jenis_modul; ?></span></h5>

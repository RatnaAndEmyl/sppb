                ...
                <div class="card card-light collapsed-card">
                    <div class="card-header">
                        <h3 class="card-title">
                            ...
                            &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp<button type="button" class="btn btn-info"></button> Penambahan Data
...
<section class="content">
    <div class="container-fluid">
        <h5 class="mb-2">DATA BARANG & GUDANG <small><i>Tambah Data Barang & Gudang</i></small></h5>
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <a href="?page=jenis_barang&pc=<?php echo $angka; ?>&oc=<?php echo md5($angka); ?>" class="btn btn-app bg-dark" style="width: 130px;">
                            <i class="fa fa-cube"></i> Jenis Barang
                        </a>

                        <a href="?page=satuan&pc=<?php echo $angka; ?>&oc=<?php echo md5($angka); ?>" class="btn btn-app bg-dark" style="width: 130px;">

                            <i class="fa fa-balance-scale"></i> Satuan Barang
                        </a>

                        <a href="?page=barang&pc=<?php echo $angka; ?>&oc=<?php echo md5($angka); ?>" class="btn btn-app bg-dark" style="width: 130px;">

                            <i class="fa fa-cubes"></i> Barang
                        </a>

                        <a href="?page=jenis_barang&aksi=tambah&pc=<?php echo $angka; ?>&oc=<?php echo md5($angka); ?>" class="btn btn-app bg-info" style="width: 130px;">

                            <i class="fas fa-circle-plus"> &nbsp <i class="fa fa-cube"> </i> </i> Tambah Jenis Barang
                        </a>

                        <a href="?page=satuan&aksi=tambah&pc=<?php echo $angka; ?>&oc=<?php echo md5($angka); ?>" class="btn btn-app bg-info" style="width: 130px;">

                            <i class="fas fa-circle-plus"> &nbsp <i class="fa fa-balance-scale"> </i> </i> Tambah Satuan Barang
                        </a>

                        <a href="?page=barang&aksi=tambah&pc=<?php echo $angka; ?>&oc=<?php echo md5($angka); ?>" class="btn btn-app bg-info" style="width: 130px;">
            ...
            <div class="col-md-6">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <a href="?page=gudang&pc=<?php echo $angka; ?>&oc=<?php echo md5($angka); ?>" class="btn btn-app bg-dark" style="width: 130px;">

                            <i class="fa fa-home"> </i>Gudang
                        </a>

                        <a href="?page=mapping_usergudang&pc=<?php echo $angka; ?>&oc=<?php echo md5($angka); ?>" class="btn btn-app bg-dark" style="width: 130px;">

                            <i class="fas fa-people-roof"></i> Admin Gudang
                        </a>

                        <a href="?page=gudang&aksi=tambah&pc=<?php echo $angka; ?>&oc=<?php echo md5($angka); ?>" class="btn btn-app bg-info" style="width: 130px;">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <a href="?page=suplier&pc=<?php echo $angka; ?>&oc=<?php echo md5($angka); ?>" class="btn btn-app bg-dark" style="width: 130px;">
                            <i class="fa fa-shopping-cart"></i> Suplier
                        </a>

                        <a href="?page=suplier&aksi=tambah&pc=<?php echo $angka; ?>&oc=<?php echo md5($angka); ?>" class="btn btn-app bg-info" style="width: 130px;">
                            <i class="fas fa-circle-plus"> &nbsp <i class="fa fa-shopping-cart"></i></i>Tambah Suplier
                        </a>

                        <a href="?page=home&aksi=home_history_stok" class="btn btn-app bg-success" style="width: 130px;">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <a href="?page=karyawan&pc=<?php echo $angka; ?>&oc=<?php echo md5($angka); ?>" class="btn btn-app bg-dark" style="width: 130px;">
                            <i class="fa fa-users"></i> Karyawan
                        </a>

                        <a href="?page=user&pc=<?php echo $angka; ?>&oc=<?php echo md5($angka); ?>" class="btn btn-app bg-dark" style="width: 130px;">
                            <i class="fas fa-id-card"></i> Pengguna
                        </a>

                        <a href="?page=fingeruser&aksi=tarikfinger&pc=<?php echo $angka; ?>&oc=<?php echo md5($angka); ?>" class="btn btn-app bg-info" style="width: 130px;">
                            <i class="fa fa-user-plus"></i> Tambah Karyawan
                        </a>

                        <a href="?page=fingeruser&aksi=upload&pc=<?php echo $angka; ?>&oc=<?php echo md5($angka); ?>" class="btn btn-app bg-info" style="width: 130px;">
            ...
            <div class="col-md-6">
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <a href="?page=departemen&pc=<?php echo $angka; ?>&oc=<?php echo md5($angka); ?>" class="btn btn-app bg-dark" style="width: 130px;">
                            <i class="fa fa-sitemap"></i> Departemen
                        </a>

                        <a href="?page=subdepartemen&pc=<?php echo $angka; ?>&oc=<?php echo md5($angka); ?>" class="btn btn-app bg-dark" style="width: 130px;">
                            <i class="fas fa-folder-tree"></i> Sub-Departemen
                        </a>

                        <a href="?page=jabatan&pc=<?php echo $angka; ?>&oc=<?php echo md5($angka); ?>" class="btn btn-app bg-dark" style="width: 130px;">
                            <i class="fa fa-briefcase"></i> Jabatan

                        </a>

                        <a href="?page=departemen&aksi=tambah&pc=<?php echo $angka; ?>&oc=<?php echo md5($angka); ?>" class="btn btn-app bg-info" style="width: 130px;">

                            <i class="fas fa-circle-plus"> &nbsp <i class="fa fa-sitemap"></i> </i> Tambah Departemen

                        </a>

                        <a href="?page=subdepartemen&aksi=tambah&pc=<?php echo $angka; ?>&oc=<?php echo md5($angka); ?>" class="btn btn-app bg-info" style="width: 130px;">

                            <i class="fas fa-circle-plus"> &nbsp <i class="fas fa-folder-tree"> </i> </i> Tambah Sub Departemen
                        </a>

                        <a href="?page=jabatan&aksi=tambah&pc=<?php echo $angka; ?>&oc=<?php echo md5($angka); ?>" class="btn btn-app bg-info" style="width: 130px;">
